...
### Chapter 2: Be a [§mirror]({{< relref "mirroring" >}}) {#chapter-2-be-a-mirror--dot-dot-mirroring-dot-md}
...
Here is a sample [§Email]({{< relref "email" >}}) sent by Chris to a client who was not committing to buying tickets to their negotiation class before a deadline:
...
Bending their reality is in reference to [§Loss Aversion]({{< relref "loss_aversion" >}}).
...
-   Humans naturally want what's [§Fair]({{< relref "fairness" >}}), even if it means losing out.
