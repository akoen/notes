...
- Writing is everything. Do everything as if nothing counts except writing. ([[file:How-to-Take-Smart-Notes.org][§How to Take Smart Notes]])
...
- When we decide on a hypothesis, we immediately disregard any contradictory information and look only for arguments which support our thesis.
  - This is an example of the [[file:belief-bias.org][§Belief bias]]
...
- *Collecting quotes without context is an ineffective research technique.*
  - It is much more valuable to take "Smart Notes" on the main point. ([[file:20200218112318.org][#active-recall]])
...
* The note-taking process from [[file:How-to-Take-Smart-Notes.org][§How to Take Smart Notes]]:
