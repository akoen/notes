...
- author :: [[file:../hannah_fry.org][§Hannah Fry]]
...
- We implicitly trust algorithms even when they contradict common sense (in a famous case, a man almost drove off a cliff because his GPS led him astray). Yet when an algorithm is wrong once, we completely lose faith in its ability [[file:../precautionary_principle.org][(§Precautionary Principle)]].
...
— [[file:../hannah_fry.org][§Hannah Fry]]
#+end_quote
