...
— Carissa Véliz, [[file:books/privacy_is_power.org][§Privacy is Power]]
#+end_quote
...
- Moreover, in 2021 it was revealed that a similar dataset was purchased by the Iowa Air National Guard, a military unit that carries out international drone strikes ([[https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard][source]]). This dataset includes the precise location of millions of smartphone users collected without their knowledge from thousands of different apps, notably including several high-profile Muslim prayer apps ([[https://www.vice.com/en/article/jgqm5x/us-military-location-data-xmode-locate-x][source]]).
...
* The words used to describe privacy are misleading
