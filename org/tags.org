...
- Tagging is useful, but only if one tags the keywords for which the given note may add to the discussion. ([[file:How-to-Take-Smart-Notes.org][§How to Take Smart Notes]])
